...
public class ControlEnterOneIntegerVariable {
    ...
    public void setInt(){
        int textField = Integer.parseInt(CarModelTextField.getText().trim());
        try {
            ...
            tableView.loadCarsByCarInOperationForMoreThanNYears(textField);
